-- [[https://gist.github.com/bitingsock/17d90e3deeb35b5f75e55adb19098f58][Precache the next entry in your playlist if it is a network source by downloading it to a temp file ahead of time. Change Line 1 to temp directory. It will delete the directory on exit. · GitHub]]

local cachePath = "mpv-cache"
local nextIndex
local caught = true
local pop = false
local ytdl = "yt-dlp"
