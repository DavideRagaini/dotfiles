;;; ../../sources/dotfiles/dot-config/doom/load/calibredb.el -*- lexical-binding: t; -*-

(use-package! calibredb
  :defer t
  :config
  (setq calibredb-root-dir "~/bks/Calibre Library"
        calibredb-db-dir (expand-file-name "metadata.db" calibredb-root-dir)
        calibredb-library-alist '(("~/bks/papers")
                                  ("~/doc/Docs/")
                                  ("~/uni/Tirocinio/Readings")
                                  )))

(setq calibredb-virtual-library-alist '(
        ("1. Personal" . "personal \\(pdf\\|mobi\\|azw3\\|azw\\|djvu\\|epub\\)")
        ("2. Work" . "work \\(pdf\\|mobi\\|azw3\\|azw\\|djvu\\|epub\\)")
        )
      )

;; (require 'org-ref)
;; (setq calibredb-ref-default-bibliography "~/org/biblio/references.bib")
